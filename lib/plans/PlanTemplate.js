...
class PlanTemplate {
   ...
   */
  addBillingCycle ({ version = 1, fixedPrice, pricingModel, tiers  }, { intervalUnit, intervalCount }, tenureType = "REGULAR", sequence = 1) {
    const billingCycleObject = {};
    this.enforceNumberSize(version, 0, 999, "version");
    billingCycleObject.pricing_scheme.version = version;
